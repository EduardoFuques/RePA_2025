...
class ObraAudiovisual(Base):
    ...
    user_id = Column(String, ForeignKey("users.id"), nullable=False)  # Usuario que registra
    
    # === IDENTIFICACIÓN ===
    codigo_agam = Column(String(50), unique=True, nullable=True)  # Código asignado por AGAM

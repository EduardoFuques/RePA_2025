...
@admin_router.get(
    "/{user_id}", response_model=UserOut, description="Obtener un usuario por ID"
)
async def get_user(
    user_id: str,
...
@admin_router.put(
    "/{user_id}/roles",
    response_model=UserOut,
    description="Modificar los roles de un usuario",
)
...
@admin_router.delete(
    "/{user_id}",
    description="Cambiar estado de 'is_active' del usuario 'user_id', solo para administrador.",
)
